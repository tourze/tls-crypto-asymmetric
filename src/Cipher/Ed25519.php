...
class Ed25519 implements AsymmetricCipherInterface
{
    ...
    {
        $this->validateKeyAndSignatureLengths($publicKey, $signature);
    ...
    private function validateKeyAndSignatureLengths(string $publicKey, string $signature): void
    {
        $publicKeyBytes = $this->getPublicKeyBytesLength();
        $signBytes = $this->getSignatureBytesLength();
    ...
    private function getPublicKeyBytesLength(): int
    {
        return defined('ParagonIE_Sodium_Compat::CRYPTO_SIGN_PUBLICKEYBYTES') ?
    ...
    private function getSignatureBytesLength(): int
    {
        return defined('ParagonIE_Sodium_Compat::CRYPTO_SIGN_BYTES') ?
